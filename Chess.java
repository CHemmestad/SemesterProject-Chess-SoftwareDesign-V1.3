...
public class Chess extends MouseAdapter {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            imgs[0] = ImageIO.read(new File("KingWnew.png"));
            imgs[1] = ImageIO.read(new File("QueenWnew.png"));
            imgs[2] = ImageIO.read(new File("BishopWnew.png"));
            imgs[3] = ImageIO.read(new File("KnightWnew.png"));
            imgs[4] = ImageIO.read(new File("RookWnew.png"));
            imgs[5] = ImageIO.read(new File("PawnWnew.png"));

            imgs[6] = ImageIO.read(new File("KingBnew.png"));
            imgs[7] = ImageIO.read(new File("QueenBnew.png"));
            imgs[8] = ImageIO.read(new File("BishopBnew.png"));
            imgs[9] = ImageIO.read(new File("KnightBnew.png"));
            imgs[10] = ImageIO.read(new File("RookBnew.png"));
            imgs[11] = ImageIO.read(new File("PawnBnew.png"));
            for (int x = 0 ; x < 12 ; x++){
            ...
            public void paint(Graphics g) {
                ...
                for ( int y = 0 ; y < 8 ; y++ ){
                    for ( int x = 0 ; x < 8 ; x++ ){
                        if(validMoves[x][y] == 3) {
                            check = true;
                            System.out.println("In check"); //CHECK*****************
                        }
                        if(Wking.inCheck) {
                            g.setColor(Color.red);
                            g.fillRect(Wking.xPosition*100, Wking.yPosition*100, 100, 100);
                        }
                        if(Bking.inCheck) {
                            g.setColor(Color.red);
                            g.fillRect(Bking.xPosition*100, Bking.yPosition*100, 100, 100);
                        }
                        if(validMoves[x][y] == 2) {
